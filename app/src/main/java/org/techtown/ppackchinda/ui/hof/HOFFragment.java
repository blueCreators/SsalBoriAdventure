...
public class HOFFragment extends ListFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        //DB에서 가져와 아이템 추가
        adapter.addhof(0,"길",System.currentTimeMillis()+500);
        adapter.addhof(0,"김",System.currentTimeMillis());
        adapter.addhof(0,"이",System.currentTimeMillis()+100);
    ...
    public class ListViewAdapterhof extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            ListViewItemhof listViewItem = listViewItemList.get(position);
