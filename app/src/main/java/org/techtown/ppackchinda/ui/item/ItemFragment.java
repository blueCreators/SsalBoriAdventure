package org.techtown.ppackchinda.ui.item;
...
public class ItemFragment extends ListFragment  {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        // 첫 번째 아이템 추가.
        //if() 사용자데이터
        if(GameMainActivity.getChap()>=3 && iscat == false)
        {
        ...
        // 두 번째 아이템 추가.
        if(GameMainActivity.getChap() >= 7 && iscard == false)
        {
            adapter.addItem(ContextCompat.getDrawable(getActivity(), R.mipmap.cat_game),
